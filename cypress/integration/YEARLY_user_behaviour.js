describe ('user behaviour inshaALLAH', () => {
  ...
  it ('user made Khatm should be able to take Part', () => {
    ...
    cy
      .get (
        '#root > div:nth-child(4) > div:nth-child(4) > div > div:nth-child(4) > input'
      )
      .type ('test');
    //type description
    cy
      .get (
        '#root > div:nth-child(4) > div:nth-child(4) > div > div:nth-child(6) > textarea'
      )
      .type ('description');
    //click Continue
    ...
    cy
      .findByText (/new khatm is ready!/i, {timeout: 10000})
      .should ('be.visible');
    ...
    cy
      .get (
        `#root > div:nth-child(4) > div:nth-child(4) > div > div > div > div:nth-child(${Part})`
      )
      .click ();
    //type the name
    let username = 'test kullanıcı';
    ...
    cy
      .get (
        `#root > div:nth-child(4) > div:nth-child(4) > div > div > div > div:nth-child(${Part}) > div:nth-child(1) > div > div > span:nth-child(2)`
      )
  ...
  it ('user should be able to take Part and release', () => {
    ...
    cy
      .get (
        `#root > div:nth-child(4) > div:nth-child(4) > div > div > div > div:nth-child(${Part}) > div > div > div`
      )
      .click ({force: true});
    //type the name
    cy.wait (2000);
