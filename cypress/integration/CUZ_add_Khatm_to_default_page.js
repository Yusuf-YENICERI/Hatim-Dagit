describe ('add Khatm to default page', () => {
  ...
  it ('user should be able to add khatm to default page, should be able to take Part and release', () => {
    ...
    cy
      .get (
        '#questionContainer > div:nth-child(1) > div > div > div > div > button:nth-child(1)'
      )
      .click ();
    ...
    cy
      .get (
        `#questionContainer > div:nth-child(12) > div > div > div > div:nth-child(${Part}) > div:nth-child(1) > :nth-child(3)`
      )
