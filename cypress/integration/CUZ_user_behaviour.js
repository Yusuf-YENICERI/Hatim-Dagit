describe ('user behaviour inshaALLAH', () => {
  ...
  it ('user made Khatm should be able to make new Part', () => {
    ...
    cy
      .get (
        '#root > div:nth-child(4) > div:nth-child(2) > div > div:nth-child(4) > input'
      )
      .type ('test');
    //type description
    cy
      .get (
        '#root > div:nth-child(4) > div:nth-child(2) > div > div:nth-child(6) > textarea'
      )
      .type ('description');
    //click Continue
    ...
    cy
      .get (
        `#questionContainer > div:nth-child(11) > div > div > div > div:nth-child(${Part}) > div`
      )
      .click ();
    //type the name
    let username = 'test kullanıcı';
    ...
    cy
      .get (
        `#questionContainer > div:nth-child(11) > div > div > div > div:nth-child(${Part}) > div:nth-child(1) > :nth-child(3)`
      )
    ...
    cy
      .get (
        `#questionContainer > div:nth-child(11) > div > div > div > div:nth-child(${Part})`
      )
      .click ();
    //click to release it
