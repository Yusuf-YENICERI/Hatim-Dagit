...
describe('add Khatm to default page', ()=>{
    ...
    it('user should be able to add khatm to default page, should be able to take Part and release', ()=>{
        ...
        cy.get('#root > div:nth-child(4) > div:nth-child(2) > div:nth-child(1) > div > div > div > div > button:nth-child(1)').click()
        cy.wait(3000)
             //click on some Part
        ...
        //type the name
        let username = "test kullanıcı"
        cy.get('#modalPartYillik-body > div > div:nth-child(1)').as('testModal')
        cy.get('@testModal').type(username)
        //click to Take it
