...
describe('user behaviour inshaALLAH', ()=>{
    ...
    it('user made Khatm should be able to make new Part', () => {
        ...
        cy.get(`#questionContainer > div:nth-child(8) > div:nth-child(2) > div > div > div:nth-child(${Part}) > div:nth-child(3)`).should('have.text', username)
    ...
    it('other user should be able to check if Part is taken and should take another Part', ()=>{
        ...
        cy.get('#takeButton').click()
        //check the name of the Part
        cy.get(`#questionContainer > div:nth-child(8) > div:nth-child(2) > div > div > div:nth-child(${Part}) > div:nth-child(3)`).should('have.text', other_user)
    })
...
describe('add Khatm to default page', ()=>{
    ...
    it('user should be able to add khatm to default page, should be able to take Part and release', ()=>{
        ...
        cy.get('#takeButton').click()
        //check the name of the Part
        cy.get(`#questionContainer > div:nth-child(10) > div:nth-child(2) > div > div > div:nth-child(${Part}) > div:nth-child(3)`).should('have.text', username)
    ...
    it('user should be able to add khatm to default page, other user should be able to check if Part is taken and should take another Part', ()=>{
        ...
        cy.get('#takeButton').click()
        //check the name of the Part
        cy.get(`#questionContainer > div:nth-child(10) > div:nth-child(2) > div > div > div:nth-child(${Part}) > div:nth-child(3)`).should('have.text', other_user)
    })
