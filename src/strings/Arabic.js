let Arabic = {
  ...
  Pwa: {
    ...
    SorryMessage: [
      `عزيزي مستخدم خدمة توزيع الختم`,

      `أولاً، نود أن نشكر جميع أعضائنا الذين استخدموا الموقع. تم توزيع الحاتم بكميات كبيرة لشهداء فلسطين. جزاكم الله خيرًا.`,

      `للأسف، أدى التوجه المفاجئ للموقع بكثرة الاستخدام اليوم إلى دخول مرحلة إعادة هيكلة. لذا، نأسف لإعلامكم بأننا اضطررنا إلى إيقاف الموقع مؤقتًا حتى يتمكن من التعامل مع الضغط الحالي`,

      `لندعو من أجل فلسطين ونبقى نصلي. نحن لا نزال نؤمن بأننا سنرى أيامًا أفضل معًا، إن شاء الله`,

      `ختم توزيع`,
    ],

    UnderMaintenance: [
      `عزيزي مستخدم خدمة خاتم للتوزيع`,
      `(2-3 ساعات)لقد تم إدخال موقعنا للصيانة لفترة قصيرة`,
      'May Allay be pleased for your understanding.',
      `بارك الله فيكم على تفهمكم.`,
      `خاتم توزيع`,
    ],
  },
